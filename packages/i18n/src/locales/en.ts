...
const en: TranslationKeys = {
  ...
  lobby: {
    title: 'Open games',
    empty: 'No open game right now. Create one!',
    hostedBy: "{{nickname}}'s game",
    seats: '{{taken}} of {{total}} seats taken',
    join: 'Join',
  },
  offline: {
  ...
  game: {
    ...
    rematchQuestion: 'Play again?',
    rematchYes: 'Play again',
    rematchWaiting: 'Waiting for {{names}}...',
    rematchStarting: 'Starting the new game...',
    rematchDeclined: '{{names}} does not want another game.',
